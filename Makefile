###############################################
#
# Plugin that implements django-channels in order to generate notifications on edx-platform. commands.
#
###############################################
...
quality: clean ## check coding style with pycodestyle and pylint
	pycodestyle ./openedx_proversity_notifications
	pylint ./openedx_proversity_notifications --rcfile=./setup.cfg
